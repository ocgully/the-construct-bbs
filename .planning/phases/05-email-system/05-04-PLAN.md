...
4. Update config.toml to uncomment and activate mail submenu items:
   ...
   This requires updating the command handler in session.rs to recognize "mail" command and route to show_inbox(). Add this alongside existing command handlers (quit, profile, who, etc.).
